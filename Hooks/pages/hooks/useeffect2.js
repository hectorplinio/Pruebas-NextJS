...
export default function useEffectPage() {
    ...
    const [resourceType, setResourceType] = useState('es');
    ...
    useEffect(() => {
        fetch(`http://covid19.secuoyas.com/api/v1/es`)
        ...
        <>
            <div className="flex flex-row items-center justify-center w-full flex-1 px-20 text-center pt-20">
                <button
                    ...
                    onClick={() => setResourceType('es')}><img 
